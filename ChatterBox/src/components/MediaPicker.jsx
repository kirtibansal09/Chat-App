...
const MediaPicker = (modalOpen) => {
    ...
    return (
        <div
            className={`fixed left-0 top-0 z-999999 flex h-full min-h-screen w-full items-center justify-center bg-black/90 px-4 py-5 ${media ? "block" : "hidden"
                }`}
        >
            ...
            >
                ...
                {/* FileDropZone */}
                <FileDropZone maxFileSize={16 * 1024 *1024}/>
